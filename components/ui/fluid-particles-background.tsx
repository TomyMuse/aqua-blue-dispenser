...
const COLOR_SCHEME = {
  water: {
    particle: "rgba(125, 211, 252, 0.3)", // sky-300 celeste
    background: "rgba(240, 249, 255, 0.1)", // sky-50 muy suave
  }
} as const;
...
export const FluidParticlesBackground = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ctx.fillStyle = COLOR_SCHEME.water.background;
      ...
      for (const particle of particles) {
        ...
        const opacity =
          Math.sin((particle.life / particle.maxLife) * Math.PI) * 0.25;
