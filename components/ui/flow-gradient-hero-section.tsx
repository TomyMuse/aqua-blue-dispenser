...
class TouchTexture {
  size = 64; width = 64; height = 64; maxAge = 64; radius = 0.12; speed = 1/64;
...
class GradientBackground {
  ...
  constructor(sceneManager: any) {
    ...
    this.uniforms = {
      ...
      uColor4: { value: new THREE.Vector3(0.85, 0.95, 1.0) }, // Glacial White/Cyan
      uColor5: { value: new THREE.Vector3(0.02, 0.3, 0.6) },  // Deep Sea
      uColor6: { value: new THREE.Vector3(0.4, 0.75, 0.95) }, // Pure Light Blue
      uSpeed: { value: 0.8 }, 
      uIntensity: { value: 1.6 },
      uTouchTexture: { value: null }, uGrainIntensity: { value: 0.04 },
      uDarkNavy: { value: new THREE.Vector3(0.95, 0.98, 1.0) }, // Background tint
      uGradientSize: { value: 0.5 }, uGradientCount: { value: 10.0 },
      uColor1Weight: { value: 0.6 }, uColor2Weight: { value: 1.4 }
    };
  }
  init() {
...
export default function LiquidGradient({ children }: LiquidGradientProps) {
